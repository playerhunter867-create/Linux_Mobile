...
class MainActivity : AppCompatActivity() {
    ...
    private fun desktop() {
        ...
        val title = textView("🐧 LinOx Mobile", 28f).apply {
        ...
        val info = textView(
            "\nLinux development environment for Android\n\n${runtime.status()}\n\n" +
                ...
                "With bundled ARM64 PRoot + a selected Linux rootfs, commands execute inside Linux."
        )

        val linuxSetup = Button(this).apply {
            text = if (runtime.isLinuxReady()) "🐧 Linux READY — Manage distributions"
                   else "🐧 Set up Linux / PRoot / Distributions"
            setOnClickListener {
