...
class TerminalActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        if (!started && runtime.isLinuxReady()) {
            startPty()
        }

        setupBanner.visibility =
            if (runtime.isLinuxReady()) LinearLayout.GONE
    ...
    private fun buildUi() {
        ...
        setupBanner = LinearLayout(this).apply {
            ...
            setBackgroundColor(Color.rgb(30, 22, 40))
            visibility = LinearLayout.GONE
        }

        setupBanner.addView(
            TextView(this).apply {
                text = "No Linux distribution installed yet."
        ...
        input = EditText(this).apply {
            ...
            hint = "type here or use the keys"
            imeOptions = EditorInfo.IME_ACTION_SEND

            setOnEditorActionListener { _, _, _ ->
                sendText(text.toString() + "\r")
                text.clear()
                true
            }
        ...
        val send = Button(this).apply {
            text = "Send"
            setOnClickListener {
                sendText(input.text.toString() + "\r")
                input.text.clear()
            }
        }
        ...
        if (!runtime.isLinuxReady()) {
            ...
            terminal.feed(
                "[LinOx] No Linux distribution installed yet.\r\n" +
                    "[LinOx] Tap \"Install Ubuntu/Debian\" above, or Menu -> " +
                    "Packages/Distros, to get set up.\r\n"
            )
