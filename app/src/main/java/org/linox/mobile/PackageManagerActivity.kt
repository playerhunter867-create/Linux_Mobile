...
class PackageManagerActivity : AppCompatActivity() {
    ...
    companion object {
        val PRESETS = listOf(
            ...
            Preset(
                "📦 Linux essentials",
                "bash, procps, ca-certificates, jq, file, tree, less, zip, tar, gzip, xz",
                listOf("bash", "procps", "ca-certificates", "jq", "file", "tree", "less", "zip", "tar", "gzip", "xz-utils")
            ),
            Preset(
                "🔐 Remote / network",
                "OpenSSH client, DNS tools, iproute2",
