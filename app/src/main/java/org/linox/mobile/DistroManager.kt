    ...
    companion object {
        ...
        val CATALOG = listOf(
            ...
            Distro("debian12", "Debian 12", "debian:12",
                "Stable Debian environment", "apt"),
            Distro("alpine320", "Alpine Linux 3.20", "alpine:3.20",
                "Small and fast Linux", "apk"),
            Distro("fedora40", "Fedora 40", "fedora:40",
                "Fedora development environment", "dnf"),
            Distro("arch", "Arch Linux", "archlinux:latest",
                "Rolling-release Arch environment", "pacman"),
            Distro("kali", "Kali Linux Rolling", "kalilinux/kali-rolling:latest",
                "Security-focused Linux userspace", "apt"),
            Distro("rocky9", "Rocky Linux 9", "rockylinux:9",
                "RHEL-compatible Linux userspace", "dnf"),
            Distro("opensuse156", "openSUSE Leap 15.6", "opensuse/leap:15.6",
                "Stable openSUSE environment", "zypper")
        )
    }
