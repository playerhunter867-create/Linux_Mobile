...
class DistroManager(
    ...
    companion object {
        ...
        val CATALOG = listOf(
            ...
            Distro("debian13", "Debian 13", "debian:13",
                "Current stable Debian userspace", "apt"),
            Distro("alpine322", "Alpine Linux 3.22", "alpine:3.22",
                "Small and fast Linux", "apk"),
            Distro("fedora42", "Fedora 42", "fedora:42",
            ...
            Distro("opensuse", "openSUSE Leap", "opensuse/leap:latest",
