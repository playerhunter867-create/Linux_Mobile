...
class MainActivity : AppCompatActivity() {
    ...
    private fun legacyTerminal() {
        ...
        val input = EditText(this).apply { hint="ls -la"; setSingleLine(true); setTextColor(0xffffffff.toInt()); inputType=InputType.TYPE_CLASS_TEXT }
    ...
    private fun code() {
        ...
        val path=EditText(this).apply{hint="filename.py";setSingleLine(true);setTextColor(0xffffffff.toInt())}
